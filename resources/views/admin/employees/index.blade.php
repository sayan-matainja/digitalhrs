...
@section('main-content')
    ...
    <section class="content">
        ...
        <div class="card mb-4">
            ...
            <form class="forms-sample card-body pb-0" action="{{ route('admin.employees.index') }}" id="employeeFilterForm"
                method="get">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xxl-3 col-xl-3 col-md-6 mb-4">
                        ...
                        <select class="form-control " id="officeTime" name="office_time_id">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="dropdown-menu p-0">
                                                <ul class="list-unstyled p-1 mb-0">
                                                    ...
                                                    @can('view_card_pdf')
                                                        <li class="dropdown-item py-2">
                                                            <a href="{{ route('employee.card.view', $value->employee_code) }}"
                                                                target="_blank">
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data.departments ?? data, function(i, dept) {
                        $('#department').append('<option value="' + dept.id + '">' + dept
                            .dept_name + '</option>');
                    });
                }
            });
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data.employee ?? [], function(i, emp) {
                        $('#supervisor').append('<option value="' + emp.id + '">' + emp.name +
                            '</option>');
                    });
                }
            });
                    ...
                    if (response.officeTimes && response.officeTimes.length > 0) {
                        ...
                        $.each(response.officeTimes, function(i, shift) {
                            ...
                            if (!addedShifts.has(shift.id)) {
                                ...
                                $('#office_time').append('<option value="' + shift.id + '">' +
                ...
                success: function(data) {
                    if (data.posts && data.posts.length > 0) {
                        $.each(data.posts ?? data, function(i, post) {
                            $('#post').append('<option value="' + post.id + '">' + post
                                .post_name + '</option>');
                        });
                    }
                }
