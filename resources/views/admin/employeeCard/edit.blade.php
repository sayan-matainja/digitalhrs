            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title mb-0">Edit ID Card Template</h3>
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.card.update-template',$setting->id) }}" id="idCardForm" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
