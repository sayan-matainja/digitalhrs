    ...
    <section class="content">
       ...
       @include('admin.trainingManagement.types.common.breadcrumb')
        <div class="card mb-4">
            ...
            <form class="forms-sample card-body pb-0" action="{{ route('admin.training-types.index') }}" method="get">
                <h5 class="mb-3">@lang('index.training_type_filter')</h5>
                <div class="row align-items-center">
                    @if(!isset(auth()->user()->branch_id))
                        <div class="col-lg-4 col-md-6 mb-4">
                            <select class="form-select" id="filter_branch_id" name="branch_id">
                    ...
                    @endif
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <input type="text" class="form-control" placeholder="@lang('index.type')" name="type" id="filter_title" value="{{ $filterParameters['type'] }}">
                        </div>

                    <div class="col-lg-2 col-md-6 mb-4">
                        <div class="d-flex">
                            <button type="submit" class="btn btn-block btn-success me-2">@lang('index.filter')</button>
                            <a class="btn btn-block btn-primary" href="{{ route('admin.training-types.index') }}">@lang('index.reset')</a>
                        </div>
                    </div>
                </div>
            </form>
        ...
        <div class="card">
            <div class="card-header">
                <h6 class="card-title mb-0">{{ __('index.training_type_list') }}</h6>
            </div>
            <div class="card-body">
